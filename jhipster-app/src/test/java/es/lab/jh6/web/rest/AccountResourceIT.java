package es.lab.jh6.web.rest;

import es.lab.jh6.Jh6App;
import es.lab.jh6.config.Constants;
import es.lab.jh6.domain.User;
import es.lab.jh6.repository.AuthorityRepository;
import es.lab.jh6.repository.UserRepository;
import es.lab.jh6.security.AuthoritiesConstants;
import es.lab.jh6.service.UserService;
import es.lab.jh6.service.dto.PasswordChangeDTO;
import es.lab.jh6.service.dto.UserDTO;
import es.lab.jh6.web.rest.vm.KeyAndPasswordVM;
import es.lab.jh6.web.rest.vm.ManagedUserVM;
...
import static es.lab.jh6.web.rest.AccountResourceIT.TEST_USER_LOGIN;
...
@SpringBootTest(classes = Jh6App.class)
